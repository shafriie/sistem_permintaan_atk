				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Mengelola Data Departemen</h4>
							</div>
					...
					<div class="row">
						<table class="stripe hover multiple-select-row data-table-export nowrap">
							...
							<tbody>
								...
								<?php $primaryKey = $val->kd_departemen; ?>
								<tr>
				...
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myLargeModalLabel">Form Departemen</h4>
						...
						<div class="modal-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" name="kd_departemen" placeholder="Kode Departemen">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Nama Departemen</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" name="nama_departemen" placeholder="Nama Departemen" type="text">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Gedung</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" name="gedung" placeholder="Gedung" type="text">
								</div>
							</div>
						</div>
