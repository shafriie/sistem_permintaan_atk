				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Laporan Permintaan ATK</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?= site_url('dashboard'); ?>">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Laporan Permintaan ATK</li>
								</ol>
							</nav>
						</div>
						...
						<table class="stripe hover multiple-select-row data-table-export nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td><?= $val->satuan ?></td>
									<td>
										<?php if($val->status == 1){$s = '<span class="badge badge-danger">Pending</span>';} ?>
										<?php if($val->status == 2){$s = '<span class="badge badge-success">Progress</span>';} ?>
